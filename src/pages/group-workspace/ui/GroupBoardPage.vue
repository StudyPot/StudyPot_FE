...
watch(
  ...
  // 다른 페이지(AI 팀장 '게시물 보러가기'/'게시판으로 가기')에서 ?postId= 로 바로 진입할 때도 상세를 열도록 초기 실행.
  { immediate: true },
)
...
// 게시글 본문 마크다운 렌더링. AI 팀장이 쓴 글(주차/수료 리포트, 질문 공유)이 GFM(제목/표/리스트/코드 등)을
// 그대로 표현되도록 marked + DOMPurify 로 통일한다. (AI 채팅 렌더와 동일 방식)
